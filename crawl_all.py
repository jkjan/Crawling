...
from cve.cve_details import cve_details
...
cve_details(err, path, 1, products_total[0:6])
cve_details(err, path, 2, products_total[6:12])
cve_details(err, path, 3, products_total[12:])
err.close()
